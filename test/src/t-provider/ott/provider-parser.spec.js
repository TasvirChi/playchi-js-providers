...
describe('provider parser', function () {
  describe('_getMediaType', () => {
    it('should check TasvirchiLiveAsset with enableTrickPlay true and externalIds > 0 returns live with dvr', done => {
    ...
    it('should check TasvirchiLiveAsset with enableTrickPlay false returns live with dvr false', done => {
    ...
    it('should check TasvirchiLiveAsset with enableTrickPlay true returns live with dvr true', done => {
      const MediaLiveAssetDataCopy = JSON.parse(JSON.stringify(MediaLiveAssetData));
      MediaLiveAssetDataCopy.externalIds = 0;
      const typeData = OTTProviderParser._getMediaType(MediaLiveAssetDataCopy, 'media', 'PLAYBACK');
      typeData.type.should.equal('Live');
